...
This repository intentionally contains no application source code — it exists only to host static legal pages that require a public URL (e.g. for the Google Play Store listing).
